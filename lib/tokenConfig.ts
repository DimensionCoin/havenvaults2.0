...
export const STOCK_TOKENS: TokenMeta[] = [
  ...
  },
  {
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "cJpUMp5R7rZ6fGeLHbHhrRuJzK9mkyKDjZqNpT3ondo" },
  },
  {
    name: "AliBaba",
    symbol: "BABA",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "1zvb9ELBFShBCWKEk5jRTJAaPAwtVt7quEXx1X4ondo" },
  },
  {
    name: "iShares Silver Trust(ETF)",
    symbol: "SLV",
    id: "ishares-silver-trust-ondo-tokenized-stock",
    logo: "/logos/slvon.png",
    kind: "stock",
    categories: ["Stocks", "Commodity"],
    tags: ["Stocks"],
    decimals: 8,
    mints: { mainnet: "iy11ytbSGcUnrjE6Lfv78TFqxKyUESfku1FugS9ondo" },
  },
  {
    name: "Lockheed",
    symbol: "LMT",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "EoReHwUnGGekbXFHLj5rbCVKiwWqu32GrETMfw4ondo" },
  },
  {
    name: "Coinbase",
    symbol: "COIN",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "5u6KDiNJXxX4rGMfYT4BApZQC5CuDNrG6MHkwp1ondo" },
  },
  {
    name: "Pfizer",
    symbol: "PFE",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "Gwh9fPsX1qWATXy63vNaJnAFfwebWQtZaVmPko6ondo" },
  },
  {
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "keybg184d4vyXeQdFqs4o99YsMg7xBthxTJ6Ky3ondo" },
  },
  {
    name: "Pepsi",
    symbol: "PEP",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "gud6b3fYekjhMG5F818BALwbg2vt4JKoow59Md9ondo" },
  },
  {
    name: "IBM",
    symbol: "IBM",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "C8bZkgSxXkyT1RgxByp2teJ24hgimPLoyEYoNa9ondo" },
  },
  {
    name: "Blackrock, inc.",
    symbol: "BLK",
    ...
    tags: ["Index"],
    decimals: 8,
    mints: { mainnet: "5H1VpMzRuoNtRbPTRCz35ETtEUtnkt8hJuQb9v7ondo" },
  },
